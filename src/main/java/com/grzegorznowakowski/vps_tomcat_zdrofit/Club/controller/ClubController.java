...
public class ClubController {
    ...
    public List<Count> getAverageCount(@PathVariable(name = "id") Long id,
                                       @PathVariable(name = "day") @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate day) {
    ...
    public List<CountResponse> getCountForClubAndDay(@PathVariable(name = "id") Long id,
                                                     @PathVariable(name = "day") @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate day) {
        return clubService.getCountForClubAndDayAll(id, day);
    }
}
